...
const tableName = 'admin.purchase-order-item';

export class PurchaseOrderItemMigration1740210517292 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const foreignKeys = [
      { column: 'po_id', refTable: 'admin.purchase-order' },
