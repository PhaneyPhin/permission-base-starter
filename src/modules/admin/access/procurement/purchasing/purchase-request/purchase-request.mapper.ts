...
export class PurchaseRequestMapper {
  public static async toDto(
    ...
    dto.totalCost = entity.totalCost
      ? parseFloat(entity.totalCost as any)
      : null;
    dto.totalEstimatedPrice = entity.totalEstimatedPrice
      ? parseFloat(entity.totalEstimatedPrice as any)
      : null;
    ...
    if (entity.items && entity.items.length > 0) {
      dto.items = await Promise.all(
        entity.items.map((item) =>
          PurchaseRequestItemMapper.toDto({
            ...item,
  ...
  public static toUpdateEntity(
    ...
    entity.totalCost = dto.totalCost;
    entity.totalEstimatedPrice = dto.totalEstimatedPrice;
    entity.requestedById = dto.requestedById;
    entity.priority = dto.priority;
    entity.currencyCode = dto.currencyCode;
    entity.status = dto.status;
    entity.description = dto.description;
