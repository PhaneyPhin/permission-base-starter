...
export class PaymentTermMapper {
  public static async toDto(entity: PaymentTermEntity): Promise<PaymentTermResponseDto> {
  ...
  public static toCreateEntity(dto: CreatePaymentTermRequestDto): PaymentTermEntity {
