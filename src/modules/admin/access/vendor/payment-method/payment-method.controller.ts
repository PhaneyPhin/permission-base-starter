...
import { PAYMENT-METHOD_FILTER_FIELDS, PaymentMethodService } from './payment-method.service';
import {
...
export class PaymentMethodController {
  ...
  @ApiFields(PAYMENT-METHOD_FILTER_FIELDS)
  @Permissions(
  ...
  @Get()
  public getPaymentMethods(@PaginationParams() pagination: PaginationRequest): Promise<PaginationResponseDto<PaymentMethodResponseDto>> {
    return this.paymentMethodService.list<PaymentMethodEntity, PaymentMethodResponseDto>(pagination);
  }
  ...
  @Get('/select-options')
  public getAllPaymentMethodForSelect(): Promise<{ id: string, name: string }[]> {
  ...
  @Get('/:id')
  public getPaymentMethodById(@Param('id', ParseIntPipe) id: number): Promise<PaymentMethodResponseDto> {
  ...
  public createPaymentMethod(
    ...
    return this.paymentMethodService.createPaymentMethod({ ...dto,  createdBy: user.id });
  }
