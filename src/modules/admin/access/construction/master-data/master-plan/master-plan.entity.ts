...
export class MasterPlanEntity extends BaseEntity {
  ...
  @ManyToOne(() => DimensionEntity, { nullable: true, eager: true })
  @JoinColumn({ name: 'project' })
  project: DimensionEntity;

  @ManyToOne(() => DimensionEntity, { nullable: true, eager: true })
  @JoinColumn({ name: 'block' })
  block: DimensionEntity;

  @ManyToOne(() => DimensionEntity, { nullable: true, eager: true })
  @JoinColumn({ name: 'building' })
  building: DimensionEntity;

  @ManyToOne(() => DimensionEntity, { nullable: true, eager: true })
  @JoinColumn({ name: 'street' })
  street: DimensionEntity;

  @ManyToOne(() => DimensionEntity, { nullable: true, eager: true })
  @JoinColumn({ name: 'division' })
  division: DimensionEntity;

  @ManyToOne(() => DimensionEntity, { nullable: true, eager: true })
  @JoinColumn({ name: 'unit_type' })
  unitType: DimensionEntity;
